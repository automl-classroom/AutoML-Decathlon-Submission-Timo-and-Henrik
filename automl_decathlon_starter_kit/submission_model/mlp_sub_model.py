...
def get_mlp_model(task_type:str, output_size: int, input_lenght: int, random_state=None):   
    """
    ****************************************************************************
    ****************************************************************************
    Args:
        ...
        input_lenght: The number of datapoints.
        random_state: a random state for reproducability
    Returns:
        model: A configured MLP model for the given task.
    """
     
    # Common model params
    batch_size = input_lenght//10
    model_params = {
    ...
    if task_type=="single-label":
        ...
        model = MultiOutputClassifier(MLPClassifier(**model_params))
...
class Model:
    ...
    def train(self, x, y, x_val, y_val, remaining_time_budget=None):
        ...
        ****************************************************************************
        ...
        # Creating mlp model
        self.model = get_mlp_model(self.task_type, self.output_dim, x.shape[0])
        ...
        logger.info(
            "{:.2f} sec used for mlpoost. ".format(
                train_duration
            )
